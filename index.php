...
<!-- added anchor tags to logo and 'How it works' for links to home page and admin page -->
        ...
        <article>
            ...
            <h5>Register your new account to get access to beast deals in the city. Or <a href="#"><span><b>login</b></span></a> with the existing account</h5>
            <form id="submit-form" action="" method="post" name="form1">
                ...
                <div>
                    <input id="password-input" type="text" placeholder="Choose your password…" 
                    name="pass" value="<?php echo $pass ?>">
                </div>
                <div>
                    <input id="password-verify" type="text" placeholder="Re-enter chosen password…" 
                    name="pass" value="<?php echo $pass ?>">                   
